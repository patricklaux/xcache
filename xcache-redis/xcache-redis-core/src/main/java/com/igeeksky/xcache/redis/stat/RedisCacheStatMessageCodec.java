 ...
 */
public class RedisCacheStatMessageCodec implements StreamMessageCodec<CacheStatMessage> {
    ...
    public RedisCacheStatMessageCodec(Codec<CacheStatistics> statCodec, StringCodec stringCodec) {
        ...
        this.first = ByteArray.of(this.stringCodec.encode("first"));
        this.second = ByteArray.of(this.stringCodec.encode("second"));
        this.third = ByteArray.of(this.stringCodec.encode("third"));
    }
